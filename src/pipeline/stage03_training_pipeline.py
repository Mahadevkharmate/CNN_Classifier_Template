...
def main():
    ...
    callbacks_list = prepare_callbacks.get_callbacks() #get the list of callbacks including early stopping

    training_config = config.get_training_config() #get the training configuration
    training = Training(config=training_config,callbacks_config = callbacks_list) #create a Training object
